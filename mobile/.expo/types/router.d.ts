...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings` | `/settings` | `/(tabs)/trainer` | `/trainer` | `/login`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/note/${SingleRoutePart<T>}` | `/study/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/note/[id]` | `/study/[learnspaceId]`;
